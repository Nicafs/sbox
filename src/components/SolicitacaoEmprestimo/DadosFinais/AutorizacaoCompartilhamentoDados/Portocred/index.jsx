...
export default function AutorizacaoCompartilhamentoDadosPortocred({
  enviarDados,
  loading,
}) {
  ...
  const texto = `A Portocred S/A solicita a sua autorização para o compartilhamento de informações relacionadas aos seus dados pessoais, profissionais e residenciais.
        ...
        <FormControl component="fieldset" margin="normal">
          <FormGroup aria-label="position">
            <FormControlLabelStyled
              ...
              label={
                <Typography variant="subtitle2">
                  ...
                  residencias com a instituição financeira Portocred S/A
                </Typography>
              }
            />
            <Hidden mdUp>
            ...
            <FormControlLabelStyled
              ...
              label={
                <Typography variant="subtitle2">
                  Aceito a Portocred S/A consultar{' '}
                  <Link
                    href="##"
...
AutorizacaoCompartilhamentoDadosPortocred.propTypes = {
